 ...
 */
jQuery.sap.declare("publicservices.her.mycourses.s1.Component");
//jQuery.sap.require("publicservices.her.mycourses.s1.Configuration");
jQuery.sap.require("sap.ca.scfld.md.ComponentBase");

sap.ca.scfld.md.ComponentBase.extend("publicservices.her.mycourses.s1.Component", {
		metadata : sap.ca.scfld.md.ComponentBase.createMetaData("MD", {
		// 	"name" : "Master Detail Sample",
		// 	"version" : "4.0.5",
		// 	"library" : "publicservices.her.mycourses.s1",
		// 	"includes" : [],
		// 		"dependencies" : {
		// 		"libs" : ["sap.m", "sap.me"],
		// 	"components" : []
		...
		// },
		"manifest": "json",
		viewPath : "publicservices.her.mycourses.s1.view"
	...
	createContent : function() {
		...
		return sap.ui.view({
			viewName : "publicservices.her.mycourses.s1.Main",
